        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HoursDiff = table.Column<int>(nullable: false),
                    MinutesDiff = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Rides",
                columns: new[] { "Id", "Price", "RouteId", "StartTime", "TrainId" },
                values: new object[,]
                {
                    { 1, 100.0, 1, new DateTime(2020, 5, 29, 12, 18, 7, 805, DateTimeKind.Local).AddTicks(1254), 1 },
                    { 2, 50.0, 2, new DateTime(2020, 5, 29, 12, 18, 7, 811, DateTimeKind.Local).AddTicks(6563), 2 },
                    { 3, 10.0, 3, new DateTime(2020, 5, 29, 12, 18, 7, 811, DateTimeKind.Local).AddTicks(6651), 3 },
                    { 4, 80.0, 4, new DateTime(2020, 5, 29, 12, 18, 7, 811, DateTimeKind.Local).AddTicks(6661), 4 }
                });

            migrationBuilder.InsertData(
                table: "StopsToRoutes",
                columns: new[] { "RouteId", "TrainStopId", "HoursDiff", "MinutesDiff", "StopNo" },
                values: new object[,]
                {
                    { 2, 1, 0, 0, 1 },
                    { 3, 1, 0, 37, 2 },
